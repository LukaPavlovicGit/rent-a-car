...
import raf.rentacar.notificationservice.controller.EmailController;
...
public class SwaggerConfiguration {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select().apis(RequestHandlerSelectors.basePackage(EmailController.class.getPackage().getName()))
                .build()
                .apiInfo(metaData());
    }
