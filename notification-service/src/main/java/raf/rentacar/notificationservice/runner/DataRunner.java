...
public class DataRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Email e3 = new Email(
                ...
                "reservation_successful",
                "Hello %firstname %lastname, a reservation for %car has been made successfully!");
        Email e4 = new Email(
                "reservation_cancellation",
                "reservation_cancellation",
                "Hello %firstname %lastname, a reservation for %car has been canceled successfully!");
        Email e5 = new Email(
